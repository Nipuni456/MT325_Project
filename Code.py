...
upper_bound = 100  # Adjust this value for your specific intensity range
...
_, binary_image = cv2.threshold(binary_mask_gray, 127, 255, cv2.THRESH_BINARY)
...
plt.subplot(224)
plt.title("Processed")
plt.contour(binary_image,levels=[2],colors='lime')
